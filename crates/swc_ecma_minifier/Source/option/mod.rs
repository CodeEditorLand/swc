...
use swc_common::{Mark, collections::AHashMap};
use swc_config::{CachedRegex, merge::Merge};
...
impl CompressOptions {
	pub(crate) fn sequences(&self) -> bool { self.sequences != 0 }
...
const fn default_passes() -> usize { 3 }

const fn three_by_default() -> u8 { 3 }

const fn default_ecma() -> EsVersion { EsVersion::Es5 }
