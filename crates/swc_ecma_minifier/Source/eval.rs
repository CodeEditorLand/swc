...
use swc_ecma_ast::*;
use swc_ecma_transforms_optimization::simplify::{ExprSimplifierConfig, expr_simplifier};
...
impl Mode for Eval {
	...
	fn preserve_vars(&self) -> bool { true }

	fn should_be_very_correct(&self) -> bool { false }

	fn force_str_for_tpl(&self) -> bool { true }
}
