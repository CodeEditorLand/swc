...
(function (global, factory) {
	...
	function sort(values, f = ascending) {
		...
		if (f.length === 1) {
			...
			return permute(
				values,
				values.map((d, i) => i).sort((i, j) => ascending(f[i], f[j])),
			);
		}
	...
	function brush$1(dim) {
		...
		function started(event) {
			...
			if (event.touches) {
				...
				if (keys)
					view.on("keydown.brush", keydowned, true).on(
						"keyup.brush",
						keyupped,
						true,
					);
		...
		brush.extent = function (_) {
			return arguments.length
				? ((extent =
						typeof _ === "function" ? _ : constant$4(number2(_))),
					brush)
				: extent;
		};
		...
		brush.touchable = function (_) {
			return arguments.length
				? ((touchable = typeof _ === "function" ? _ : constant$4(!!_)),
					brush)
				: touchable;
		};
	...
	function ribbon(headRadius) {
		...
		ribbon.padAngle = function (_) {
			return arguments.length
				? ((padAngle = typeof _ === "function" ? _ : constant$5(+_)),
					ribbon)
				: padAngle;
		};
	...
	function segmentContains(a, b, c) {
		var i;
		return (
			collinear(a, b, c) && within(a[(i = +(a[0] === b[0]))], c[i], b[i])
		);
	}
	...
	class Delaunay {
		...
		*neighbors(i) {
		...
		_step(i, x, y) {
			const { inedges, hull, _hullIndex, halfedges, triangles, points } =
				this;
		...
		var group =
			...
			numerals =
				locale.numerals === undefined
					? identity$3
					: formatNumerals(map$1.call(locale.numerals, String)),
		...
		return {
			...
			point: function (lambda1, phi1) {
				...
				if (abs$2(delta - pi$3) < epsilon$4) {
					...
					if (abs$2(lambda0 - sign0) < epsilon$4)
						lambda0 -= sign0 * epsilon$4; // handle degeneracies
					if (abs$2(lambda1 - sign1) < epsilon$4)
	...
	function conicConformalRaw(y0, y1) {
		var cy0 = cos$1(y0),
			n =
				y0 === y1
					? sin$1(y0)
					: log(cy0 / cos$1(y1)) / log(tany(y1) / tany(y0)),
		...
		return [
			lambda *
				(0.8707 -
					...
					phi4 *
						(-0.013791 +
							phi4 * (0.003971 * phi2 - 0.001529 * phi4))),
			phi *
				(1.007226 +
					phi2 *
						(0.015085 +
	...
	function radial$1() {
		...
		scale.range = function (_) {
			return arguments.length
				? (squared.range((range = Array.from(_, number$2)).map(square)),
					scale)
				: range.slice();
		};
	...
	function formatWeekNumberISO(d, p) {
		d = dISO(d);
		return pad$1(
			thursday.count(year(d), d) + (year(d).getDay() === 4),
			p,
			2,
		);
	}
	...
	function arc() {
		...
		arc.innerRadius = function (_) {
			return arguments.length
				? ((innerRadius = typeof _ === "function" ? _ : constant$a(+_)),
					arc)
				: innerRadius;
		};
		...
		arc.outerRadius = function (_) {
			return arguments.length
				? ((outerRadius = typeof _ === "function" ? _ : constant$a(+_)),
					arc)
				: outerRadius;
		};
		...
		arc.cornerRadius = function (_) {
			return arguments.length
				? ((cornerRadius =
						typeof _ === "function" ? _ : constant$a(+_)),
					arc)
				: cornerRadius;
		};
		...
		arc.startAngle = function (_) {
			return arguments.length
				? ((startAngle = typeof _ === "function" ? _ : constant$a(+_)),
					arc)
				: startAngle;
		};
		...
		arc.endAngle = function (_) {
			return arguments.length
				? ((endAngle = typeof _ === "function" ? _ : constant$a(+_)),
					arc)
				: endAngle;
		};
		...
		arc.padAngle = function (_) {
			return arguments.length
				? ((padAngle = typeof _ === "function" ? _ : constant$a(+_)),
					arc)
				: padAngle;
		};
	...
	function line(x, y) {
		...
		line.x = function (_) {
			return arguments.length
				? ((x = typeof _ === "function" ? _ : constant$a(+_)), line)
				: x;
		};

		line.y = function (_) {
			return arguments.length
				? ((y = typeof _ === "function" ? _ : constant$a(+_)), line)
				: y;
		};

		line.defined = function (_) {
			return arguments.length
				? ((defined = typeof _ === "function" ? _ : constant$a(!!_)),
					line)
				: defined;
		};
	...
	function area$3(x0, y0, y1) {
		...
		area.x = function (_) {
			return arguments.length
				? ((x0 = typeof _ === "function" ? _ : constant$a(+_)),
					(x1 = null),
					area)
				: x0;
		};
		...
		area.x0 = function (_) {
			return arguments.length
				? ((x0 = typeof _ === "function" ? _ : constant$a(+_)), area)
				: x0;
		};
		...
		area.y = function (_) {
			return arguments.length
				? ((y0 = typeof _ === "function" ? _ : constant$a(+_)),
					(y1 = null),
					area)
				: y0;
		};
		...
		area.y0 = function (_) {
			return arguments.length
				? ((y0 = typeof _ === "function" ? _ : constant$a(+_)), area)
				: y0;
		};
	...
	function pie() {
		...
		pie.value = function (_) {
			return arguments.length
				? ((value = typeof _ === "function" ? _ : constant$a(+_)), pie)
				: value;
		};
	...
	function link$2(curve) {
		...
		link.x = function (_) {
			return arguments.length
				? ((x = typeof _ === "function" ? _ : constant$a(+_)), link)
				: x;
		};

		link.y = function (_) {
			return arguments.length
				? ((y = typeof _ === "function" ? _ : constant$a(+_)), link)
				: y;
		};
	...
	function symbol(type, size) {
		...
		size =
			typeof size === "function"
				? size
				: constant$a(size === undefined ? 64 : +size);
		...
		symbol.type = function (_) {
			return arguments.length
				? ((type = typeof _ === "function" ? _ : constant$a(_)), symbol)
				: type;
		};

		symbol.size = function (_) {
			return arguments.length
				? ((size = typeof _ === "function" ? _ : constant$a(+_)),
					symbol)
				: size;
		};
	...
	function stack() {
		...
		stack.value = function (_) {
			return arguments.length
				? ((value = typeof _ === "function" ? _ : constant$a(+_)),
					stack)
				: value;
		};
	...
	function zoom() {
		...
		zoom.wheelDelta = function (_) {
			return arguments.length
				? ((wheelDelta = typeof _ === "function" ? _ : constant$b(+_)),
					zoom)
				: wheelDelta;
		};
		...
		zoom.filter = function (_) {
			return arguments.length
				? ((filter = typeof _ === "function" ? _ : constant$b(!!_)),
					zoom)
				: filter;
		};
		...
		zoom.touchable = function (_) {
			return arguments.length
				? ((touchable = typeof _ === "function" ? _ : constant$b(!!_)),
					zoom)
				: touchable;
		};
