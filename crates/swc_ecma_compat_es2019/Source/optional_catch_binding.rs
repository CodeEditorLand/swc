...
pub fn optional_catch_binding() -> impl Fold + VisitMut { as_folder(OptionalCatchBinding) }
...
mod tests {
	...
	pub fn tr() -> impl Fold {
		chain!(resolver(Mark::new(), Mark::new(), false), as_folder(OptionalCatchBinding))
	}

	test!(::swc_ecma_parser::Syntax::default(), |_| tr(), issue_411, "try {} catch {}");
