...
mod tests {
	...
	#[test]
	fn function_statement() { assert_min("function foo() {}", "function foo(){}"); }
	...
	fn for_statement_pretty() {
		assert_pretty("for (var i = 0; i < 10; i++) {}", "for(var i = 0; i < 10; i++){}");
	...
	#[test]
	fn issue_204_01() { assert_min(r"'\r\n';", r#""\r\n""#); }

	#[test]
	fn issue_204_02() { assert_min(r"const a = fn() + '\r\n';", r#"const a=fn()+"\r\n""#); }
