...
pub fn mark_fresh_proxy(parent:u32) -> u32 { Mark::fresh(Mark::from_u32(parent)).as_u32() }

pub fn mark_parent_proxy(self_mark:u32) -> u32 { Mark::from_u32(self_mark).parent().as_u32() }
...
pub fn mark_is_descendant_of_proxy(
	...
	let context =
		VersionedSerializable::new(MutableMarkContext(self_mark.as_u32(), 0, return_value as u32));
