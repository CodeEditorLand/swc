...
use wasmer::{Function, FunctionEnv, Imports, Store, imports};
...
use crate::{
	...
	imported_fn::{
		comments::{
			...
			has_leading_comments_proxy,
			has_trailing_comments_proxy,
			move_leading_comments_proxy,
