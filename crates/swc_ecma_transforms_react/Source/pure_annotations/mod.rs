...
use swc_common::{Span, collections::AHashMap, comments::Comments};
use swc_ecma_ast::*;
...
where
	C: Comments, {
	visit_mut_pass(PureAnnotations { imports:Default::default(), comments })
}
				...
				for specifier in &import.specifiers {
					...
					match specifier {
						...
						ImportSpecifier::Default(default) => {
							self.imports.insert(default.local.to_id(), (src, "default".into()));
						},
