...
impl_struct!(
	ArrowExpr,
	[span, ctxt, params, body, is_async, is_generator, type_params, return_type]
);
...
impl_struct!(JSXOpeningElement, [name, span, attrs, self_closing, type_args]);
...
impl_enum!(JSXAttrValue, [Lit, JSXExprContainer, JSXElement, JSXFragment]);
