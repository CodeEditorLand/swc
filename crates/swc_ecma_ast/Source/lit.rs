...
impl From<BigIntValue> for BigInt {
	#[inline]
	fn from(value:BigIntValue) -> Self { BigInt { span:DUMMY_SP, value:Box::new(value), raw:None } }
}
...
impl Take for Str {
	fn dummy() -> Self { Str { span:DUMMY_SP, value:js_word!(""), raw:None } }
}
...
impl From<Atom> for Str {
	#[inline]
	fn from(value:Atom) -> Self { Str { span:DUMMY_SP, value, raw:None } }
}
...
impl Take for Bool {
	fn dummy() -> Self { Bool { span:DUMMY_SP, value:false } }
}

impl From<bool> for Bool {
	#[inline]
	fn from(value:bool) -> Self { Bool { span:DUMMY_SP, value } }
}
...
impl Take for Null {
	fn dummy() -> Self { Null { span:DUMMY_SP } }
}
...
impl Take for Regex {
	fn dummy() -> Self { Self { span:DUMMY_SP, exp:Default::default(), flags:Default::default() } }
}
...
pub struct Number {
	pub span:Span,
	/// **Note**: This should not be `NaN`. Use [crate::Ident] to represent
	/// NaN.
	///
...
impl From<f64> for Number {
	#[inline]
	fn from(value:f64) -> Self { Number { span:DUMMY_SP, value, raw:None } }
}

impl From<usize> for Number {
	#[inline]
	fn from(value:usize) -> Self { Number { span:DUMMY_SP, value:value as _, raw:None } }
}
