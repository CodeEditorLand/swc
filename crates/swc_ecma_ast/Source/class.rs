...
impl Take for Class {
	fn dummy() -> Self { Class { ..Default::default() } }
}
...
impl Take for ClassMember {
	fn dummy() -> Self { ClassMember::Empty(EmptyStmt { span:DUMMY_SP }) }
}
...
impl Take for StaticBlock {
	fn dummy() -> Self { StaticBlock { span:DUMMY_SP, body:Take::dummy() } }
}
...
impl Default for Key {
	fn default() -> Self { Key::Public(Default::default()) }
}
