...
pub trait Visit {
	...
	///
	/// By default, this method calls [`CdataSection::visit_children_with`]. If
	...
	/// [`ProcessingInstruction::visit_children_with`]. If you want to recurse,
...
impl<V:?Sized + Visit> VisitWith<V> for CdataSection {
	...
	fn visit_with(&self, visitor:&mut V) { <V as Visit>::visit_cdata_section(visitor, self) }
...
impl<V:?Sized + Visit> VisitWith<V> for Element {
	...
	fn visit_children_with(&self, visitor:&mut V) {
		match self {
			Element { span, tag_name, attributes, children } => {
				{
					<swc_common::Span as VisitWith<V>>::visit_with(span, visitor)
				};
				{
...
impl<V:?Sized + Visit> VisitWith<V> for ProcessingInstruction {
	/// Calls [Visit`::visit_processing_instruction`] with `self`.
	fn visit_with(&self, visitor:&mut V) {
...
pub trait VisitAstPath {
	...
	///
	/// By default, this method calls
	/// [`CdataSection::visit_children_with_ast_path`]. If you want to recurse,
	/// you need to call it manually.
	#[inline]
	...
	///
	/// By default, this method calls
	/// [`ProcessingInstruction::visit_children_with_ast_path`]. If you want to
	/// recurse, you need to call it manually.
	#[inline]
...
impl<V:?Sized + VisitAstPath> VisitWithAstPath<V> for CdataSection {
	/// Calls [VisitAstPath`::visit_cdata_section`] with `self`.
	fn visit_with_ast_path<'ast:'r, 'r>(
		&'ast self,
		visitor:&mut V,
		__ast_path:&mut AstNodePath<'r>,
...
impl<V:?Sized + VisitAstPath> VisitWithAstPath<V> for ProcessingInstruction {
	/// Calls [VisitAstPath`::visit_processing_instruction`] with `self`.
	fn visit_with_ast_path<'ast:'r, 'r>(
		&'ast self,
		visitor:&mut V,
		__ast_path:&mut AstNodePath<'r>,
...
impl<V:?Sized + VisitAstPath> VisitWithAstPath<V> for Token {
	...
	fn visit_children_with_ast_path<'ast:'r, 'r>(
		...
		match self {
			...
			Token::EmptyTag { tag_name, attributes } => {
				let mut __ast_path = __ast_path
					.with_guard(AstParentNodeRef::Token(self, self::fields::TokenField::EmptyTag));
				{
					let mut __ast_path = __ast_path.with_guard(AstParentNodeRef::Token(
						self,
						self::fields::TokenField::TagName,
			...
			Token::Cdata { data, raw } => {
				let mut __ast_path = __ast_path
					.with_guard(AstParentNodeRef::Token(self, self::fields::TokenField::Cdata));
				{
					let mut __ast_path = __ast_path
						.with_guard(AstParentNodeRef::Token(self, self::fields::TokenField::Data));
					<swc_atoms::Atom as VisitWithAstPath<V>>::visit_with_ast_path(
...
pub trait VisitMut {
	...
	///
	/// By default, this method calls
	/// [`ProcessingInstruction::visit_mut_children_with`]. If you want to
	/// recurse, you need to call it manually.
	#[inline]
...
impl<V:?Sized + VisitMut> VisitMutWith<V> for CdataSection {
	/// Calls [VisitMut`::visit_mut_cdata_section`] with `self`.
	fn visit_mut_with(&mut self, visitor:&mut V) {
...
impl<V:?Sized + VisitMut> VisitMutWith<V> for ProcessingInstruction {
	/// Calls [VisitMut`::visit_mut_processing_instruction`] with `self`.
	fn visit_mut_with(&mut self, visitor:&mut V) {
...
pub trait VisitMutAstPath {
	...
	///
	/// By default, this method calls
	/// [`CdataSection::visit_mut_children_with_ast_path`]. If you want to
	/// recurse, you need to call it manually.
	#[inline]
	...
	///
	/// By default, this method calls
	/// [`ProcessingInstruction::visit_mut_children_with_ast_path`]. If you want
	/// to recurse, you need to call it manually.
	#[inline]
...
impl<V:?Sized + VisitMutAstPath> VisitMutWithAstPath<V> for CdataSection {
	/// Calls [VisitMutAstPath`::visit_mut_cdata_section`] with `self`.
	fn visit_mut_with_ast_path(&mut self, visitor:&mut V, __ast_path:&mut AstKindPath) {
...
impl<V:?Sized + VisitMutAstPath> VisitMutWithAstPath<V> for ProcessingInstruction {
	/// Calls [VisitMutAstPath`::visit_mut_processing_instruction`] with `self`.
	fn visit_mut_with_ast_path(&mut self, visitor:&mut V, __ast_path:&mut AstKindPath) {
...
pub trait Fold {
	...
	/// Visit a node of type `CdataSection`.
	///
	/// By default, this method calls [`CdataSection::fold_children_with`]. If
	/// you want to recurse, you need to call it manually.
	#[inline]
	...
	///
	/// By default, this method calls
	/// [`ProcessingInstruction::fold_children_with`]. If you want to recurse,
	/// you need to call it manually.
	#[inline]
...
impl<V:?Sized + Fold> FoldWith<V> for CdataSection {
	...
	fn fold_with(self, visitor:&mut V) -> Self { <V as Fold>::fold_cdata_section(visitor, self) }
...
impl<V:?Sized + Fold> FoldWith<V> for ProcessingInstruction {
	/// Calls [Fold`::fold_processing_instruction`] with `self`.
	fn fold_with(self, visitor:&mut V) -> Self {
...
pub trait FoldAstPath {
	...
	///
	/// By default, this method calls
	/// [`CdataSection::fold_children_with_ast_path`]. If you want to recurse,
	/// you need to call it manually.
	#[inline]
	...
	///
	/// By default, this method calls
	/// [`ProcessingInstruction::fold_children_with_ast_path`]. If you want to
	/// recurse, you need to call it manually.
	#[inline]
...
pub mod fields {
	...
	pub enum CdataSectionField {
		/// Represents [`CdataSection::span`]
		Span,
		/// Represents [`CdataSection::data`]
		Data,
		/// Represents [`CdataSection::raw`]
		Raw,
	}
	impl ChildField {
		#[inline(always)]
	...
	pub enum ChildField {
		...
		Text,
		/// Represents [`Child::CdataSection`]
		CdataSection,
		/// Represents [`Child::Comment`]
		Comment,
		/// Represents [`Child::ProcessingInstruction`]
		ProcessingInstruction,
	}
	impl CommentField {
		pub(crate) fn set_index(&mut self, index:usize) {
	...
	pub enum ProcessingInstructionField {
		/// Represents [`ProcessingInstruction::span`]
		Span,
		/// Represents [`ProcessingInstruction::target`]
		Target,
		/// Represents [`ProcessingInstruction::data`]
		Data,
	}
	impl TextField {
		pub(crate) fn set_index(&mut self, index:usize) {
	...
	pub enum TokenField {
		...
		EndTag,
		/// Represents [`Token::EmptyTag`]
		EmptyTag,
		/// Represents [`Token::Comment`]
		Comment,
		/// Represents [`Token::Character`]
		Character,
		/// Represents [`Token::ProcessingInstruction`]
		ProcessingInstruction,
		/// Represents [`Token::Cdata`]
		Cdata,
...
impl<'ast> From<&'ast CdataSection> for NodeRef<'ast> {
	fn from(node:&'ast CdataSection) -> Self { NodeRef::CdataSection(node) }
}
...
impl<'ast> From<&'ast ProcessingInstruction> for NodeRef<'ast> {
	fn from(node:&'ast ProcessingInstruction) -> Self { NodeRef::ProcessingInstruction(node) }
}
			...
			NodeRef::Child(node) => {
				match node {
					...
					Child::CdataSection(v0) => {
						Box::new(::std::iter::once(NodeRef::CdataSection(v0)))
					},
