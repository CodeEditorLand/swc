...
static ARRAY_NATURE_ITERATORS:&[&str] =
	&["es6.object.to-string", "es6.array.iterator", "web.dom.iterable"];
...
pub static STATIC_PROPERTIES:DataMap<DataMap<&[&str]>> = data_map!(Map {
	...
	String:Map { fromCodePoint:"es6.string.from-code-point", raw:"es6.string.raw" },
	...
	Promise:Map { all:COMMON_ITERATORS, race:COMMON_ITERATORS },
