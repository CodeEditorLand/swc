...
pub fn no_alert(
	...
	match rule_reaction {
		...
		_ => Some(visitor_rule(NoAlert::new(rule_reaction, unresolved_ctxt, es_version))),
	}
}
...
impl NoAlert {
	...
	fn is_inside_class(&self) -> bool { self.classes_depth > 0 }

	fn is_inside_object(&self) -> bool { self.objects_depth > 0 }

	fn is_inside_arrow_fn(&self) -> bool { self.arrow_fns_depth > 0 }
