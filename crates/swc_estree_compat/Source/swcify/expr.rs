...
impl Swcify for ArrayExpression {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		ArrayLit { span:ctx.span(&self.base), elems:self.elements.swcify(ctx) }
	}
}
...
impl Swcify for Arg {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		Some(match self {
			Arg::Spread(s) => {
				ExprOrSpread { spread:Some(ctx.span(&s.base)), expr:s.argument.swcify(ctx) }
			},
			Arg::JSXName(e) => ExprOrSpread { spread:None, expr:e.swcify(ctx).into() },
			Arg::Placeholder(_) => return None,
			Arg::Expr(e) => ExprOrSpread { spread:None, expr:e.swcify(ctx) },
		})
	}
}
				...
				SuperPropExpr {
					...
					prop:match (*self.property, self.computed) {
						...
						(MemberExprProp::Expr(e), true) => {
							...
							SuperProp::Computed(ComputedPropName { span:expr.span(), expr })
						},
						_ => unreachable!(),
					},
				}
			...
			_ => {
				MemberExpr {
					...
					prop:match (*self.property, self.computed) {
						...
						(MemberExprProp::Expr(e), true) => {
							let expr = e.swcify(ctx);
							MemberProp::Computed(ComputedPropName { span:expr.span(), expr })
						},
						_ => unreachable!(),
					},
				}
...
impl Swcify for ObjectExpression {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		ObjectLit { span:ctx.span(&self.base), props:self.properties.swcify(ctx) }
	}
}
...
impl Swcify for swc_estree_ast::Decorator {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		swc_ecma_ast::Decorator { span:ctx.span(&self.base), expr:self.expression.swcify(ctx) }
	}
}
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		match self {
			...
			ObjectKey::Expr(v) => {
				...
				PropName::Computed(ComputedPropName { span:expr.span(), expr })
			},
		}
	}
}
...
impl Swcify for SequenceExpression {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		SeqExpr { span:ctx.span(&self.base), exprs:self.expressions.swcify(ctx) }
	}
}
...
impl Swcify for ParenthesizedExpression {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		ParenExpr { span:ctx.span(&self.base), expr:self.expression.swcify(ctx) }
	}
}
...
impl Swcify for ThisExpression {
	...
	fn swcify(self, ctx:&Context) -> Self::Output { ThisExpr { span:ctx.span(&self.base) } }
}
...
impl Swcify for MetaProperty {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		...
		match (&*meta.sym, &*prop.sym) {
			("new", "target") => {
				MetaPropExpr { kind:MetaPropKind::NewTarget, span:ctx.span(&self.base) }
			},
			("import", "meta") => {
				MetaPropExpr { kind:MetaPropKind::NewTarget, span:ctx.span(&self.base) }
			},
...
impl Swcify for swc_estree_ast::Super {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		swc_ecma_ast::Super { span:ctx.span(&self.base) }
	}
}
...
impl Swcify for AwaitExpression {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		AwaitExpr { span:ctx.span(&self.base), arg:self.argument.swcify(ctx) }
	}
}
...
impl Swcify for TypeCastExpression {
	...
	fn swcify(self, _:&Context) -> Self::Output { unimplemented!("flow type cast") }
}
...
impl Swcify for JSXExpressionContainer {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		JSXExprContainer { span:ctx.span(&self.base), expr:self.expression.swcify(ctx) }
	}
}
...
impl Swcify for JSXEmptyExpression {
	...
	fn swcify(self, ctx:&Context) -> Self::Output { JSXEmptyExpr { span:ctx.span(&self.base) } }
}
...
impl Swcify for JSXSpreadAttribute {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		SpreadElement { dot3_token:ctx.span(&self.base), expr:self.argument.swcify(ctx) }
	}
}
...
impl Swcify for swc_estree_ast::JSXSpreadChild {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		swc_ecma_ast::JSXSpreadChild { span:ctx.span(&self.base), expr:self.expression.swcify(ctx) }
	}
}
...
impl Swcify for swc_estree_ast::JSXClosingElement {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		swc_ecma_ast::JSXClosingElement { span:ctx.span(&self.base), name:self.name.swcify(ctx) }
	}
}
...
impl Swcify for swc_estree_ast::JSXOpeningFragment {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		swc_ecma_ast::JSXOpeningFragment { span:ctx.span(&self.base) }
	}
}
...
impl Swcify for swc_estree_ast::JSXClosingFragment {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		swc_ecma_ast::JSXClosingFragment { span:ctx.span(&self.base) }
	}
}
...
impl Swcify for BindExpression {
	...
	fn swcify(self, _:&Context) -> Self::Output { panic!("swc does not support bind expressions") }
}

impl Swcify for DoExpression {
	type Output = !;

	fn swcify(self, _:&Context) -> Self::Output { panic!("swc does not support do expressions") }
}
...
impl Swcify for TupleExpression {
	...
	fn swcify(self, _:&Context) -> Self::Output { panic!("swc does not support tuple expressions") }
}
...
impl Swcify for TSNonNullExpression {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		TsNonNullExpr { span:ctx.span(&self.base), expr:self.expression.swcify(ctx) }
	}
}
...
impl Swcify for ArrayExprEl {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		match self {
			...
			ArrayExprEl::Expr(e) => ExprOrSpread { spread:None, expr:e.swcify(ctx) },
		}
	}
}
