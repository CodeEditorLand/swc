...
impl Swcify for TSTypeParameterInstantiation {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		TsTypeParamInstantiation { span:ctx.span(&self.base), params:self.params.swcify(ctx) }
	}
}
...
impl Swcify for TSTypeParameterDeclaration {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		TsTypeParamDecl { span:ctx.span(&self.base), params:self.params.swcify(ctx) }
	}
}
...
impl Swcify for TSTypeAnnotation {
	...
	fn swcify(self, ctx:&Context) -> Self::Output {
		TsTypeAnn { span:ctx.span(&self.base), type_ann:self.type_annotation.swcify(ctx) }
	}
}
