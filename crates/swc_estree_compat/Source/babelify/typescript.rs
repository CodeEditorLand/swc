...
impl Babelify for TsTypeAnn {
	...
	fn babelify(self, ctx:&Context) -> Self::Output {
		TSTypeAnnotation { base:ctx.base(self.span), type_annotation:self.type_ann.babelify(ctx) }
	}
}
...
impl Babelify for TsFnType {
	...
	fn babelify(self, ctx:&Context) -> Self::Output {
		TSFunctionType {
			...
			parameters:self.params.into_iter().map(|p| p.babelify(ctx).into()).collect(),
...
impl Babelify for TsTypeParamDecl {
	...
	fn babelify(self, ctx:&Context) -> Self::Output {
		TSTypeParameterDeclaration { base:ctx.base(self.span), params:self.params.babelify(ctx) }
	}
}
...
impl Babelify for TsCallSignatureDecl {
	...
	fn babelify(self, ctx:&Context) -> Self::Output {
		TSCallSignatureDeclaration {
			...
			parameters:self.params.into_iter().map(|param| param.babelify(ctx).into()).collect(),
	...
	fn babelify(self, ctx:&Context) -> Self::Output {
		match self.kind {
			TsKeywordTypeKind::TsAnyKeyword => {
				TsKeywordTypeOutput::Any(TSAnyKeyword { base:ctx.base(self.span) })
			},
			TsKeywordTypeKind::TsUnknownKeyword => {
				TsKeywordTypeOutput::Unknown(TSUnknownKeyword { base:ctx.base(self.span) })
			},
			TsKeywordTypeKind::TsNumberKeyword => {
				TsKeywordTypeOutput::Number(TSNumberKeyword { base:ctx.base(self.span) })
			},
			TsKeywordTypeKind::TsObjectKeyword => {
				TsKeywordTypeOutput::Object(TSObjectKeyword { base:ctx.base(self.span) })
			},
			TsKeywordTypeKind::TsBooleanKeyword => {
				TsKeywordTypeOutput::Boolean(TSBooleanKeyword { base:ctx.base(self.span) })
			},
			TsKeywordTypeKind::TsBigIntKeyword => {
				TsKeywordTypeOutput::BigInt(TSBigIntKeyword { base:ctx.base(self.span) })
			},
			TsKeywordTypeKind::TsStringKeyword => {
				TsKeywordTypeOutput::String(TSStringKeyword { base:ctx.base(self.span) })
			},
			TsKeywordTypeKind::TsSymbolKeyword => {
				TsKeywordTypeOutput::Symbol(TSSymbolKeyword { base:ctx.base(self.span) })
			},
			TsKeywordTypeKind::TsVoidKeyword => {
				TsKeywordTypeOutput::Void(TSVoidKeyword { base:ctx.base(self.span) })
			},
			TsKeywordTypeKind::TsUndefinedKeyword => {
				TsKeywordTypeOutput::Undefined(TSUndefinedKeyword { base:ctx.base(self.span) })
			},
			TsKeywordTypeKind::TsNullKeyword => {
				TsKeywordTypeOutput::Null(TSNullKeyword { base:ctx.base(self.span) })
			},
			TsKeywordTypeKind::TsNeverKeyword => {
				TsKeywordTypeOutput::Never(TSNeverKeyword { base:ctx.base(self.span) })
			},
			TsKeywordTypeKind::TsIntrinsicKeyword => {
				TsKeywordTypeOutput::Intrinsic(TSIntrinsicKeyword { base:ctx.base(self.span) })
			},
		}
	}
}
...
impl Babelify for TsThisType {
	...
	fn babelify(self, ctx:&Context) -> Self::Output { TSThisType { base:ctx.base(self.span) } }
}
...
impl Babelify for TsTypeQuery {
	...
	fn babelify(self, ctx:&Context) -> Self::Output {
		TSTypeQuery { base:ctx.base(self.span), expr_name:self.expr_name.babelify(ctx) }
	}
}
...
impl Babelify for TsTypeLit {
	...
	fn babelify(self, ctx:&Context) -> Self::Output {
		TSTypeLiteral { base:ctx.base(self.span), members:self.members.babelify(ctx) }
	}
}
...
impl Babelify for TsTupleType {
	...
	fn babelify(self, ctx:&Context) -> Self::Output {
		TSTupleType { base:ctx.base(self.span), element_types:self.elem_types.babelify(ctx) }
	}
}
...
impl Babelify for TsLitType {
	...
	fn babelify(self, ctx:&Context) -> Self::Output {
		TSLiteralType { base:ctx.base(self.span), literal:self.lit.babelify(ctx) }
	}
}
...
impl Babelify for TsInterfaceBody {
	...
	fn babelify(self, ctx:&Context) -> Self::Output {
		TSInterfaceBody { base:ctx.base(self.span), body:self.body.babelify(ctx) }
	}
}
	...
	fn babelify(self, ctx:&Context) -> Self::Output {
		fn babelify_expr(expr:Expr, ctx:&Context) -> TSEntityName {
			match expr {
				...
				Expr::Member(e) => {
					TSEntityName::Qualified(TSQualifiedName {
...
impl Babelify for TsModuleBlock {
	...
	fn babelify(self, ctx:&Context) -> Self::Output {
		TSModuleBlock {
			base:ctx.base(self.span),
			body:self.body.into_iter().map(|m| m.babelify(ctx).into()).collect(),
		}
	}
}
...
impl Babelify for TsExternalModuleRef {
	...
	fn babelify(self, ctx:&Context) -> Self::Output {
		TSExternalModuleReference { base:ctx.base(self.span), expression:self.expr.babelify(ctx) }
	}
}
...
impl Babelify for TsNamespaceExportDecl {
	...
	fn babelify(self, ctx:&Context) -> Self::Output {
		TSNamespaceExportDeclaration { base:ctx.base(self.span), id:self.id.babelify(ctx) }
	}
}
