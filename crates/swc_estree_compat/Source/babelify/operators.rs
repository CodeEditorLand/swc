...
impl From<BinaryOpOutput> for BinaryExprOp {
	fn from(o:BinaryOpOutput) -> Self {
		match o {
			...
			BinaryOpOutput::LogicOp(_) => {
				panic!("illegal conversion: Cannot convert {:?} to BinaryExprOp", &o)
			},
		}
	}
}
...
impl From<BinaryOpOutput> for LogicalExprOp {
	fn from(o:BinaryOpOutput) -> Self {
		match o {
			...
			BinaryOpOutput::BinOp(_) => {
				panic!("illegal conversion: Cannot convert {:?} to LogicalExprOp", &o)
			},
		}
	}
}
