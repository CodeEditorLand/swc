...
pub fn edge_default_param() -> impl Fold + VisitMut { as_folder(EdgeDefaultParam::default()) }
...
mod tests {
	...
	fn tr() -> impl Fold { chain!(resolver(Mark::new(), Mark::new(), false), edge_default_param()) }
