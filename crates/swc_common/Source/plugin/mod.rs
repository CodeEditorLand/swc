...
///  3. Create a new AST struct with compile time feature flag with newly added
///     properties. Previous struct should remain with existing feature flag, or
///     add previous latest feature flag.
///
