...
fn bench_cases(c:&mut Criterion) {
	c.bench_function("html/document/visitor/compare/clone", |b| run_document(b, |m:Document| m));
	...
	c.bench_function("html/document_fragment/visitor/compare/visit_mut_span", |b| {
		struct RespanVisitMut;
	...
	c.bench_function("html/document_fragment/visitor/compare/visit_mut_span_panic", |b| {
		struct RespanVisitMut;
	...
	c.bench_function("html/document_fragment/visitor/compare/fold_span_panic", |b| {
		struct RespanFold;
