...
fn bench_files(c:&mut Criterion) {
	...
	c.bench_function("es/parser/angular", |b| {
		bench_module(b, Default::default(), include_str!("./files/angular-1.2.5.js"))
	});

	c.bench_function("es/parser/backbone", |b| {
		bench_module(b, Default::default(), include_str!("./files/backbone-1.1.0.js"))
	});

	c.bench_function("es/parser/jquery", |b| {
		bench_module(b, Default::default(), include_str!("./files/jquery-1.9.1.js"))
	});
	...
	c.bench_function("es/parser/underscore", |b| {
		bench_module(b, Default::default(), include_str!("./files/underscore-1.5.2.js"))
	});

	c.bench_function("es/parser/three", |b| {
		bench_module(b, Default::default(), include_str!("./files/three-0.138.3.js"))
	});
