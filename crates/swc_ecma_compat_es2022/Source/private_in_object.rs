...
pub fn private_in_object() -> impl JsPass { as_folder(PrivateInObject::default()) }
...
impl CompilerPass for PrivateInObject {
	fn name() -> Cow<'static, str> { Cow::Borrowed("private-in-object") }
}
	...
	fn visit_mut_class(&mut self, n:&mut Class) {
		...
		if !self.cls.constructor_exprs.is_empty() {
			...
			if !has_constructor {
				...
				n.body.push(ClassMember::Constructor(default_constructor(has_super)));
			}
