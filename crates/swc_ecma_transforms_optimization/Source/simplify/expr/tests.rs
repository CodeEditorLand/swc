...
fn fold_same(s:&str) { fold(s, s) }

#[test]
fn regex() { fold("/ab/?x=1:x=2", "x=1"); }

#[test]
fn object() { fold("!({a:foo()});", "foo(), false;"); }
...
#[test]
fn test_unary_ops_3() { fold("a=~0xffffffff", "a=0"); }

#[test]
fn test_unary_ops_4() { fold("a=~~0xffffffff", "a=-1"); }
...
#[test]
fn test_fold_bitwise_op_string_compare() { fold("x = -1 | 0", "x = -1"); }
...
#[test]
#[ignore]
fn test_fold_arithmetic3_2() { fold("x = (-0) ** 3", "x = -0.0"); }
...
#[test]
fn test_fold_arithmetic_string_comp() { fold("x = 10 - 20", "x = -10"); }
...
fn test_fold_object_literal_ref1() {
	...
	fold("({a:function(){return this}}).a", "(function(){return this})");
	...
	fold("var x = ({a:function(){return 1}}).a", "var x = function(){return 1}");
	...
	fold("function f() { return {a:1, b:2}.a; }", "function f() { return 1; }");
	...
	fold("var x = {a() { return this; }}.a;", "var x = function() { return this; };");
	// `super` is invisibly captures the object that declared the method so we can't
	// fold.
	fold_same("var x = {a() { return super.a; }}.a;");
	fold("var x = {a: 1, a() { 2; }}.a;", "var x = function() { 2; };");
	fold("var x = {a() {}, a: 1}.a;", "var x = 1;");
	fold_same("var x = {a() {}}.b");
}

#[test]
fn test_fold_object_literal_ref2() { fold_same("({a:x}).a += 1"); }
...
// should be.
#[test]
fn test_fold_object_literal_method_call_non_literal_fn() { fold_same("({a:x}).a()"); }
...
#[test]
fn test_ie_string() { fold_same("!+'\\v1'"); }

#[test]
fn test_issue522() { fold_same("[][1] = 1;"); }

#[test]
fn test_es6_features() {
	fold("var x = {[undefined != true] : 1};", "var x = {[true] : 1};");
	fold("let x = false && y;", "let x = false;");
	fold("const x = null == undefined", "const x = true");
	fold("var [a, , b] = [false+1, true+1, ![]]", "var [a, , b] = [1, 2, false]");
	...
	fold("function foo() {return `${false && y}`}", "function foo() {return `${false}`}");
}
