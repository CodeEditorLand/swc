...
fn test(src:&str, expected:&str) { test_stmt!(src, expected) }

/// Should not modify expression.
fn test_same(s:&str) { test(s, s) }
...
fn test_remove_no_op_labelled_statement() {
	...
	test("a: { break a; var x = 1; } x = 2;", "a: { var x; break a; } x = 2; ");
...
fn test_fold_blocks_with_many_children() {
	...
	test("function f() { { if (false) {} if (true) {} {} } }", "function f(){}");
	test(
...
fn test_if() {
	...
	test("if (false){ x = 1; } else if (true) { x = 3; } else { x = 2; }", "x=3");
...
fn test_fold_useless_do_3() {
	...
	test("do { for (;;) {foo(); continue;} } while(0)", "for (;;) {foo(); continue;}");
	test("l1: do { for (;;) { foo() } } while(0)", "l1: for(;;) foo();");
	test("do { switch (1) { default: foo(); break} } while(0)", "foo();");
	test("do { switch (1) { default: foo(); continue} } while(0)", "foo();");
...
#[test]
fn test_fold_empty_do() { test("do { } while(true);", "for (;;);"); }
...
#[test]
fn test_remove_useless_ops1() { test_same("(function () { f(); })();"); }
...
fn test_optimize_switch_1() {
	...
	test("function f() {switch(1){default: return; case 1: break;}}", "function f() {}");
...
fn test_optimize_switch_4() {
	...
	// test_same("switch ('\\v') {\ncase '\\u000B':\n  foo();\n}");
	test(
		concat!("switch ('empty') {", "case 'empty':", "case 'foo':", "  foo();", "}",),
		"foo()",
	);
...
fn test_optimize_switch_with_labelless_break() {
	...
	test(
		concat!("let x = 1;", "switch('x') {", "  case 'x': let x = 2; break;", "}",),
...
fn test_optimize_switch_with_return() {
	...
	test(
		...
		concat!("function f() {", "  let x = 1;", "  { let x = 2; } return 3; ", "}",),
	);
}
...
#[test]
fn test_remove_number() { test("3", ""); }

#[test]
fn test_remove_var_get1() { test("a", "a"); }

#[test]
fn test_remove_var_get2() { test("var a = 1;a", "var a = 1; a"); }

#[test]
#[ignore]
fn test_remove_namespace_get1() { test("var a = {};a.b", "var a = {}"); }

#[test]
#[ignore]
fn test_remove_namespace_get2() { test("var a = {};a.b=1;a.b", "var a = {};a.b=1"); }

#[test]
#[ignore]
fn test_remove_prototype_get1() { test("var a = {};a.prototype.b", "var a = {}"); }

#[test]
#[ignore]
fn test_remove_prototype_get2() {
	test("var a = {};a.prototype.b = 1;a.prototype.b", "var a = {};a.prototype.b = 1");
}

#[test]
fn test_remove_add1() { test("1 + 2", ""); }

#[test]
fn test_no_remove_var1() { test_same("var a = 1"); }

#[test]
fn test_no_remove_var2() { test_same("var a = 1, b = 2"); }

#[test]
fn test_no_remove_assign1() { test_same("a = 1"); }

#[test]
fn test_no_remove_assign2() { test_same("a = b = 1"); }

#[test]
fn test_no_remove_assign3() { test("1 + (a = 2)", "a = 2"); }

#[test]
fn test_no_remove_assign4() { test_same("x.a = 1"); }

#[test]
fn test_no_remove_assign5() { test_same("x.a = x.b = 1"); }

#[test]
fn test_no_remove_assign6() { test("1 + (x.a = 2)", "x.a = 2"); }

#[test]
fn test_no_remove_call1() { test_same("a()"); }

#[test]
fn test_no_remove_call2() { test("a()+b()", "a(),b()"); }

#[test]
fn test_no_remove_call3() { test_same("a() && b()"); }

#[test]
fn test_no_remove_call4() { test_same("a() || b()"); }

#[test]
fn test_no_remove_call5() { test("a() || 1", "a()"); }

#[test]
fn test_no_remove_call6() { test("1 || a()", ""); }

#[test]
fn test_no_remove_throw1() { test_same("function f(){throw a()}"); }

#[test]
fn test_no_remove_throw2() { test_same("function f(){throw a}"); }

#[test]
fn test_no_remove_throw3() { test_same("function f(){throw 10}"); }

#[test]
fn test_remove_in_control_structure1() { test("if(x()) 1", "x()"); }

#[test]
fn test_remove_in_control_structure3() { test("for(1;2;3) 4", "for(;;);"); }

#[test]
fn test_hook1() { test("1 ? 2 : 3", ""); }

#[test]
fn test_hook2() { test("x ? a() : 3", "x && a()"); }

#[test]
fn test_hook3() { test("x ? 2 : a()", "x || a()"); }

#[test]
fn test_hook4() { test_same("x ? a() : b()"); }

#[test]
fn test_hook5() { test("a() ? 1 : 2", "a()"); }

#[test]
fn test_hook6() { test("a() ? b() : 2", "a() && b()"); }
...
#[test]
fn test_hook7() { test("a() ? 1 : b()", "a() || b()"); }

#[test]
fn test_hook8() { test_same("a() ? b() : c()"); }

#[test]
fn test_hook9() {
	test("true ? a() : (function f() {})()", "a()");
	test("false ? a() : (function f() {alert(x)})()", "(function f() {alert(x)})()");
}

#[test]
fn test_hook10() {
	test("((function () {}), true) ? a() : b()", "a()");
	test("((function () {alert(x)})(), true) ? a() : b()", "(function(){alert(x)})(),a()");
}

#[test]
fn test_short_circuit1() { test("1 && a()", "a()"); }

#[test]
fn test_short_circuit2() { test("1 && a() && 2", "a()"); }

#[test]
fn test_short_circuit3() { test("a() && 1 && 2", "a()"); }

#[test]
fn test_short_circuit4() { test_same("a() && 1 && b()"); }

#[test]
fn test_complex1() { test("1 && a() + b() + c()", "a(), b(), c()"); }

#[test]
fn test_complex2() { test("1 && (a() ? b() : 1)", "a() && b()"); }

#[test]
fn test_complex3() { test("1 && (a() ? b() : 1 + c())", "a() ? b() : c()"); }

#[test]
fn test_complex4() { test("1 && (a() ? 1 : 1 + c())", "a() || c()"); }
...
#[test]
fn test_no_remove_function_declaration1() { test_same("function foo(){}"); }

#[test]
fn test_no_remove_function_declaration2() { test_same("var foo = function (){}"); }

#[test]
fn test_no_simplify_function_args1() { test("f(1 + 2, 3 + g())", "f(3, 3 + g())"); }

#[test]
fn test_no_simplify_function_args2() { test("1 && f(1 + 2, 3 + g())", "f(3, 3 + g())"); }
...
#[test]
fn test_no_remove_inherits3() { test_same("this.a = {}; var b = {}; b.inherits(a);"); }
...
#[test]
fn test_remove_from_label1() { test("LBL: void 0", ""); }

#[test]
fn test_remove_from_label2() { test("LBL: foo() + 1 + bar()", "LBL: foo(),bar()"); }
...
#[test]
#[ignore]
fn test_empty_pattern_in_declaration_removed_2() { test("var [] = foo();", "foo()"); }
...
#[test]
fn issue_1851_1() { test("x ?? (x = 'abc');", "x ?? (x = 'abc');"); }
