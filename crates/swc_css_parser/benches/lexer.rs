...
fn bench_files(c:&mut Criterion) {
	run(c, "bootstrap_5_1_3", include_str!("./files/bootstrap_5_1_3.css"));

	run(c, "foundation_6_7_4", include_str!("./files/foundation_6_7_4.css"));

	run(c, "tailwind_3_1_1", include_str!("./files/tailwind_3_1_1.css"));
fn bench_stylesheet(b: &mut Bencher, src: &'static str) {
    let _ = ::testing::run_test(false, |cm, _| {
        let fm = cm.new_source_file(FileName::Anon.into(), src.into());
